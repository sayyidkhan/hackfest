    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50 text-mtc-blue">
      <div className="container mx-auto px-4 pt-6 pb-16 space-y-16">
        ...
        <section
          ...
          className="space-y-6 border-t border-mtc-blue/20 pt-10"
        >
          <h2 className="text-2xl font-bold text-mtc-blue">Side Events</h2>
          <p className="text-sm md:text-base text-mtc-blue/80 max-w-2xl">
            Leading up to the hackathon, join our side events to learn, network,
            and get to know the Mosque Tech Challenge community.
          </p>

          <div className="grid gap-4 text-sm text-mtc-blue/80 md:grid-cols-3">
            <article className="rounded-2xl border border-mtc-blue/20 bg-white p-4 space-y-2 shadow-sm">
              <p className="text-xs font-bold uppercase tracking-wide text-mtc-green">
                Example · Workshop
              </p>
              <h3 className="text-sm font-bold text-mtc-blue">Intro to Hackathon &amp; Ideation</h3>
              <p className="text-xs text-mtc-blue/70">
            ...
            <article className="rounded-2xl border border-mtc-blue/20 bg-white p-4 space-y-2 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-mtc-blue">Meet the Mentors</h3>
              <p className="text-xs text-mtc-blue/70">
            ...
            <article className="rounded-2xl border border-mtc-blue/20 bg-white p-4 space-y-2 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-mtc-blue">Tech Stack Q&amp;A</h3>
              <p className="text-xs text-mtc-blue/70">
